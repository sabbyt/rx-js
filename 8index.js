...
var responseStream = requestOnRefreshStream
  ...
  // will share network requests
  // shared Observable
  // internally only one subscribe
  // 1 - if late subscriber, will not do a new network request but will replay that same json that happened before
  .shareReplay(1);
